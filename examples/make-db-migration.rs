...
fn wasm_migration(updates: &mut Vec<migrations::DbUpdateType>) {
    ...
    let wasm_updates: Vec<(&str, &str, &[u8])> =
        ...
        (
            ...
            "tx_transfer.wasm",
            //include_bytes!("tx_transfer.83afcbf97c35188991ae2e73db2f48cb8d019c4295fe5323d9c3dfebcd5dbec0.wasm"),
            &[0xDE, 0xAD, 0xBE, 0xEF],
        ),
        (
            "6ff3c2a2ebc65061a9b89abd15fb37851ca77e162b42b7989889bd537e802b09",
            "tx_ibc.wasm",
            //include_bytes!("tx_ibc.6ff3c2a2ebc65061a9b89abd15fb37851ca77e162b42b7989889bd537e802b09.wasm"),
            &[0xDE, 0xAD, 0xBE, 0xEF],
        ),
    ];
