...
impl Ledger {
    pub fn new(
        ...
        tendermint_config.rpc.laddr = TendermintAddress::from_str("127.0.0.1:26657").unwrap();
        tendermint_config.p2p.laddr = TendermintAddress::from_str("127.0.0.1:26656").unwrap();
        tendermint_config.p2p.persistent_peers = vec![];
        tendermint_config.p2p.pex = true;
        tendermint_config.p2p.allow_duplicate_ip = false;
        ...
        Self {
            ...
            // get rid of this and move tendermint_mode into the shell config
            ...
            //     tx_index: false,
            // },
            tendermint_config: tendermint_config,
        }
    }
