...
mod test {
    ...
    fn test_calculate_construct_tx_data() {
        ...
        let update = calculate_eth_msg_update(MultiSignedEthEvent {
    ...
    #[test]
    fn test_calculate_eth_msg_updates_empty() {
        let updates = calculate_eth_msg_updates(vec![]);

        assert!(updates.is_empty());
    }

    #[test]
    fn test_calculate_eth_msg_update_one_validator_one_transfer() {
        let sole_validator = address::testing::established_address_1();
        ...
        let update = calculate_eth_msg_update(with_signers);

        assert_eq!(update, expected);
    }

    #[test]
    fn test_calculate_eth_msg_update_two_validators_one_transfer() {
    ...
    #[test]
    fn test_calculate_eth_msg_updates_one_validator_two_transfers() {
        let sole_validator = address::testing::established_address_1();
        let receiver = address::testing::established_address_2();
        let nonce = 1;
        ...
        let updates = calculate_eth_msg_updates(with_signers);

        assert_eq!(updates, expected);
    }

    #[test]
    fn test_calculate_eth_msg_updates_two_validators_two_transfers() {
        let validator_a = address::testing::established_address_1();
        let validator_b = address::testing::established_address_3();
        let receiver = address::testing::established_address_2();
        let nonce = 1;
