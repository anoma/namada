...
pub mod wrapper_tx {
    ...
    impl WrapperTx {
        ...
        pub fn generate_fee_unshielding(
            ...
            transfer_code_tag: Option<String>,
            unshield: Transaction,
            //FIXME: should this return an owned version of BatchedTx? Maybe not, I don't need ownership of the commitments, just of tx but I cannot do self-referencing struct
        ) -> Result<Tx, WrapperTxErr> {
