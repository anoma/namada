...
fn init_null_rewards() -> Result<()> {
    ...
    token::write_params(
        &Some(token::ShieldedParams {
            ...
            locked_amount_target: token::Poly::from(0).switch(),
            precision: None,
        }),
        &mut node.shell.lock().unwrap().state,
        &test_token_addr,
    ...
    token::write_params(
        &Some(token::ShieldedParams {
            ...
            locked_amount_target: token::Poly::from(999999999u64).switch(),
            precision: None,
        }),
        &mut node.shell.lock().unwrap().state,
        &test_token_addr,
...
fn values_spanning_multiple_masp_digits() -> Result<()> {
    ...
    token::write_params(
        &Some(token::ShieldedParams {
            ...
            locked_amount_target: token::Poly::from(u64::MAX).switch(),
            precision: None,
        }),
        &mut node.shell.lock().unwrap().state,
        &test_token_addr,
