...
mod tests {
    ...
    fn test_ibc_client() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ClientMsg::from(ibc::msg_create_client())).into(),
        ));
        let mut tx = Tx::new(ChainId::default(), None);
        tx.add_code(vec![], None)
            .add_data(&msg)
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ClientMsg::from(ibc::msg_update_client(
                client_id,
            )))
            .into(),
        ));
    ...
    fn test_ibc_connection_init_and_open() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ConnectionMsg::from(
                ibc::msg_connection_open_init(client_id),
            ))
            .into(),
        ));
        let mut tx = Tx::new(ChainId::default(), None);
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ConnectionMsg::from(
                ibc::msg_connection_open_ack(conn_id, client_state),
            ))
            .into(),
        ));
        let mut tx = Tx::new(ChainId::default(), None);
    ...
    fn test_ibc_connection_try_and_open() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ConnectionMsg::from(
                ibc::msg_connection_open_try(client_id, client_state),
            ))
            .into(),
        ));
        let mut tx = Tx::new(ChainId::default(), None);
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ConnectionMsg::from(
                ibc::msg_connection_open_confirm(conn_id),
            ))
            .into(),
        ));
        let mut tx = Tx::new(ChainId::default(), None);
    ...
    fn test_ibc_channel_init_and_open() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(ibc::msg_channel_open_init(
                port_id.clone(),
                conn_id,
            )))
            .into(),
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(ibc::msg_channel_open_ack(
                port_id, channel_id,
            )))
            .into(),
        ));
    ...
    fn test_ibc_channel_try_and_open() {
        ...
        let port_id = ibc::PortId::transfer();
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(ibc::msg_channel_open_try(
                port_id.clone(),
                conn_id,
            )))
            .into(),
        ...
        let channel_id = ibc::ChannelId::new(0);
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(ibc::msg_channel_open_confirm(
                port_id, channel_id,
            )))
            .into(),
        ));
    ...
    fn test_ibc_channel_close_init_fail() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(ibc::msg_channel_close_init(
                port_id, channel_id,
            )))
            .into(),
        ));
        ...
        actions.add_transfer_module(dummy_module);
        actions.execute(&msg).expect("closing the channel failed");
    ...
    fn test_ibc_channel_close_confirm() {
        ...
        // Start a transaction to close the channel
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(ChannelMsg::from(
                ibc::msg_channel_close_confirm(port_id, channel_id),
            ))
            .into(),
        ));
    ...
    fn test_ibc_send_token() {
        ...
        let tx_data = IbcMessage::Transfer(msg.clone());
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(PacketMsg::from(ibc::msg_packet_ack(packet)))
                .into(),
        ));
    ...
    fn test_ibc_burn_token() {
        ...
        let tx_data = IbcMessage::Transfer(msg);
    ...
    fn test_ibc_receive_token() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(PacketMsg::from(ibc::msg_packet_recv(packet)))
                .into(),
        ));
    ...
    fn test_ibc_packet_timeout() {
        ...
        tx_host_env::ibc::ibc_actions(tx::ctx())
            .execute(&IbcMessage::Transfer(msg.clone()))
            .expect("sending a token failed");
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(PacketMsg::from(ibc::msg_timeout(
                packet,
                ibc::Sequence::from(1),
            )))
            .into(),
    ...
    fn test_ibc_timeout_on_close() {
        ...
        let msg = IbcMessage::Envelope(Box::new(
            MsgEnvelope::from(PacketMsg::from(ibc::msg_timeout_on_close(
                packet,
                ibc::Sequence::from(1),
            )))
            .into(),
