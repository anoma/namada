    ...
    impl Args for TxBecomeValidator<CliTypes> {
        ...
        fn def(app: App) -> App {
            app.add_args::<Tx<CliTypes>>()
                ...
                .arg(VALIDATOR_ALIAS.def().help("The validator's alias."))
        ...
        fn def(app: App) -> App {
            app.add_args::<Tx<CliTypes>>()
                ...
                .arg(VALIDATOR_ALIAS_OPT.def().help(
                    "The desired new validator alias. To remove the \
                     existing validator alias, pass an empty string to this argument.",
                ))
                .arg(
                    COMMISSION_RATE_OPT
                        .def()
