...
pub mod main {
    ...
    #[transaction]
    fn apply_tx(_ctx: &mut Ctx, _tx_data: SignedTxData) -> TxResult {
        Ok(())
    }
}
...
pub mod main {
    ...
    #[transaction]
    fn apply_tx(_ctx: &mut Ctx, tx_data: SignedTxData) -> TxResult {
...
pub mod main {
    ...
    #[transaction]
    fn apply_tx(ctx: &mut Ctx, _tx_data: SignedTxData) -> TxResult {
        // governance
