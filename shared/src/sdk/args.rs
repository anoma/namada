...
impl TxCustom {
    ...
    pub async fn build<'a>(&self, context: &mut impl Namada<'a>) ->
        crate::sdk::error::Result<(crate::proto::Tx, SigningTxData, Option<Epoch>)>
    {
...
impl Unbond {
    /// Build a transaction from this builder
    pub async fn build<'a>(&self, context: &mut impl Namada<'a>) ->
        crate::sdk::error::Result<(crate::proto::Tx, SigningTxData, Option<Epoch>, Option<(Epoch, token::Amount)>)>
    {
