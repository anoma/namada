    ...
    CA: WasmCacheAccess,
{
    wasmer::imports! {
        ...
        "env" => {
            ...
            "anoma_vp_read_temp_pre" => Function::new_native_with_env(wasm_store, env.clone(), host_env::vp_read_temp_pre),
            "anoma_vp_read_temp_post" => Function::new_native_with_env(wasm_store, env.clone(), host_env::vp_read_temp_post),
