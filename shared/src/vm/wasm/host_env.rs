    ...
    CA: WasmCacheAccess,
{
    wasmer::imports! {
        ...
        "env" => {
            ...
            "anoma_tx_get_tx_index" => Function::new_native_with_env(wasm_store, env.clone(), host_env::tx_get_tx_index),
    ...
    CA: WasmCacheAccess,
{
    wasmer::imports! {
        ...
        "env" => {
            ...
            "anoma_vp_get_tx_index" => Function::new_native_with_env(wasm_store, env.clone(), host_env::vp_get_tx_index),
