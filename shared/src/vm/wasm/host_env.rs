...
use wasmer::{Function, FunctionEnv, Imports, Instance, Memory, Store};
    ...
    CA: WasmCacheAccess,
{
    wasmer::imports! {
        ...
        "env" => {
            ...
            "namada_tx_emit_ibc_event" => Function::new_typed_with_env(wasm_store, env, host_env::tx_emit_ibc_event),
            ...
            "namada_tx_get_block_hash" => Function::new_typed_with_env(wasm_store, env, host_env::tx_get_block_hash),
    ...
    CA: WasmCacheAccess,
{
    ...
    wasmer::imports! {
        ...
        "env" => {
            ...
            "namada_vp_get_block_hash" => Function::new_typed_with_env(wasm_store, &env, host_env::vp_get_block_hash),
            "namada_vp_get_tx_code_hash" => Function::new_typed_with_env(wasm_store, &env, host_env::vp_get_tx_code_hash),
            "namada_vp_get_block_epoch" => Function::new_typed_with_env(wasm_store, &env, host_env::vp_get_block_epoch),
            ...
            "namada_vp_has_valid_pow" => Function::new_typed_with_env(wasm_store, &env, host_env::vp_has_valid_pow),
