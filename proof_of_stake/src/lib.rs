...
use types::{
    into_tm_voting_power, BelowCapacityValidatorSet, BondDetails, BondId,
    BondsAndUnbondsDetail, BondsAndUnbondsDetails, ConsensusValidator,
    ConsensusValidatorSet, EagerRedelegatedBondsMap, GenesisValidator,
    Position, RedelegatedBondsOrUnbonds, RedelegatedTokens, Redelegation,
    ReverseOrdTokenAmount, Slash, SlashType, SlashedAmount, Slashes,
    TotalRedelegatedUnbonded, UnbondDetails, Unbonds,
    ValidatorPositionAddresses, ValidatorSetUpdate, ValidatorState, VoteInfo,
    WeightedValidator,
};
...
use crate::storage::{
    ...
    rewards_accumulator_handle, total_bonded_handle,
    total_consensus_stake_key_handle, total_deltas_handle,
    total_unbonded_handle, unbond_handle, validator_addresses_handle,
