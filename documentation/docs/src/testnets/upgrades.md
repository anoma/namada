...
The testnet launches on 15/03/2023 at 17:00 UTC with the genesis validators from `public-testnet-5`. It launches with [version v0.14.2](https://github.com/anoma/namada/releases/tag/v0.14.2) and chain-id `TBD`. 
